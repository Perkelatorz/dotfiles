...
Item {
    ...
    Rectangle {
        ...
        color: mouseArea.pressed ? Qt.darker(kbWidget.pillColor, 1.15) : mouseArea.containsMouse ? Qt.lighter(kbWidget.pillColor, 1.2) : kbWidget.pillColor
        border.width: 1
        border.color: mouseArea.containsMouse ? Qt.lighter(kbWidget.pillColor, 1.4) : kbWidget.pillColor
        ...
        MouseArea {
            ...
            onClicked: kbWidget.toggleRequested()
            Row {
                id: row
