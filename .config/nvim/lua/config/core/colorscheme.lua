...
function M.setup()
	...
	vim.api.nvim_set_hl(0, "IblIndent", { fg = colors.ui3, nocombine = true })
	vim.api.nvim_set_hl(0, "IblWhitespace", { fg = colors.bg2, nocombine = true })
	vim.api.nvim_set_hl(0, "IblScope", { fg = colors.ui_teal, nocombine = true })
	...
	-- Spell: undercurl + light background so mistakes are easy to spot (not only a thin line).
	...
	vim.api.nvim_set_hl(0, "SpellCap", { fg = colors.fg0, bg = "#3a3520", undercurl = true, sp = colors.warn })
	vim.api.nvim_set_hl(0, "SpellRare", { fg = colors.fg0, bg = "#252838", undercurl = true, sp = colors.type })
	vim.api.nvim_set_hl(0, "SpellLocal", { fg = colors.fg0, bg = "#283028", undercurl = true, sp = colors.purple_lavender })
	...
	vim.api.nvim_set_hl(0, "TelescopeSelectionCaret", { fg = colors.ui_teal, bg = colors.bg3, bold = true })
	...
	vim.api.nvim_set_hl(0, "CmpItemKindFunction", { fg = colors.callable, bold = false })
	vim.api.nvim_set_hl(0, "CmpItemKindMethod", { fg = colors.callable, bold = false })
	vim.api.nvim_set_hl(0, "CmpItemKindKeyword", { fg = colors.control, bold = false })
	vim.api.nvim_set_hl(0, "CmpItemKindSnippet", { fg = colors.type, bold = false })
	vim.api.nvim_set_hl(0, "CmpItemKindVariable", { fg = colors.fg1, bold = false })
	vim.api.nvim_set_hl(0, "CmpItemKindText", { fg = colors.fg2, bold = false })
	...
	vim.api.nvim_set_hl(0, "NotifyERRORBody", { fg = colors.fg1, bg = colors.bg1 })
	vim.api.nvim_set_hl(0, "NotifyWARNBody", { fg = colors.fg1, bg = colors.bg1 })
	vim.api.nvim_set_hl(0, "NotifyINFOBody", { fg = colors.fg1, bg = colors.bg1 })
	vim.api.nvim_set_hl(0, "NotifyDEBUGBody", { fg = colors.fg1, bg = colors.bg1 })
	vim.api.nvim_set_hl(0, "NotifyTRACEBody", { fg = colors.fg1, bg = colors.bg1 })
	vim.api.nvim_set_hl(0, "NotifyERRORTitle", { fg = colors.error, bg = colors.bg1, bold = true })
	vim.api.nvim_set_hl(0, "NotifyWARNTitle", { fg = colors.warn, bg = colors.bg1, bold = true })
	vim.api.nvim_set_hl(0, "NotifyINFOTitle", { fg = colors.type, bg = colors.bg1, bold = true })
	vim.api.nvim_set_hl(0, "NotifyDEBUGTitle", { fg = colors.ui1, bg = colors.bg1, bold = true })
	vim.api.nvim_set_hl(0, "NotifyTRACETitle", { fg = colors.control, bg = colors.bg1, bold = true })

	vim.api.nvim_set_hl(0, "NeoTreeNormal", { fg = colors.fg0, bg = colors.bg0 })
	vim.api.nvim_set_hl(0, "NeoTreeRootName", { fg = colors.control, bold = true })
	vim.api.nvim_set_hl(0, "NeoTreeDirectoryIcon", { fg = colors.ui1 })
	vim.api.nvim_set_hl(0, "NeoTreeDirectoryName", { fg = colors.fg1 })
	vim.api.nvim_set_hl(0, "NeoTreeFileIcon", { fg = colors.ui2 })
	vim.api.nvim_set_hl(0, "NeoTreeFileName", { fg = colors.fg0 })
	vim.api.nvim_set_hl(0, "NeoTreeGitAdded", { fg = colors.float_color })
	vim.api.nvim_set_hl(0, "NeoTreeGitModified", { fg = colors.warn })
	vim.api.nvim_set_hl(0, "NeoTreeGitDeleted", { fg = colors.error })
	vim.api.nvim_set_hl(0, "NeoTreeGitIgnored", { fg = colors.ui3 })
	vim.api.nvim_set_hl(0, "NeoTreeGitConflict", { fg = colors.match_paren })
	vim.api.nvim_set_hl(0, "NeoTreeGitUntracked", { fg = colors.fg3 })
	...
	vim.api.nvim_set_hl(0, "TroubleNormal", { fg = colors.fg0, bg = colors.bg1, bold = false })
	vim.api.nvim_set_hl(0, "TroubleIndent", { fg = colors.ui3, nocombine = true })
	vim.api.nvim_set_hl(0, "TroubleFilename", { fg = colors.ui1, bold = false })
	vim.api.nvim_set_hl(0, "TroubleSource", { fg = colors.comment, italic = true })
	vim.api.nvim_set_hl(0, "TroublePos", { fg = colors.fg3 })
...
function M.apply_nightfox()
	...
	if not nightfox_ok then
		vim.notify("Nightfox not installed. Add it with vim.pack.add() and :restart.", vim.log.levels.WARN)
		return
	end
