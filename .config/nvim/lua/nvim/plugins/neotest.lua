return {
	...
	config = function()
		...
		local neotest, neotest_ok = utils.safe_require("neotest")
		...
		local python_adapter, python_ok = utils.safe_require("neotest-python")
		if python_ok then
		...
		local go_adapter, go_ok = utils.safe_require("neotest-go")
		if go_ok then
		...
		local jest_adapter, jest_ok = utils.safe_require("neotest-jest")
		if jest_ok then
		...
		local vitest_adapter, vitest_ok = utils.safe_require("neotest-vitest")
		if vitest_ok then
