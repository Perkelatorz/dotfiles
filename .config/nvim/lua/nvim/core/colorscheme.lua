...
function M.setup()
	local utils = require("nvim.core.utils")
		...
		local colors = {
			...
			color1 = "#5BF65B",    -- Comments, hints (bright green)
			color2 = "#9acf9a", -- Strings (light green)
			color3 = "#5a9a8a",  -- Classes, types (night evergreen)
			color4 = "#9d8bc8",   -- Keywords, constants (muted purple)
			color5 = "#f56600",   -- Numbers, warnings (Clemson orange)
			color6 = "#FFD343",   -- Functions (Python yellow - official Python logo color) - for function calls
			color7 = "#FFE066", -- Brighter yellow for function definitions
			color8 = "#B7F239",     -- Operators (bright lime-yellow green)
			color9 = "#F174F1",     -- Symbols (bright magenta)
			color10 = "#8ab5b5",     -- Variables, builtins, info (softer cyan, easier on eyes)
			color11 = "#5a7ab8",     -- Brackets (more blue, less gray - distinct from builtins)
			color12 = "#00ffff",     -- Punctuation (bright cyan - very visible, high contrast)
