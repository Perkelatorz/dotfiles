...
Item {
    ...
    Rectangle {
        id: pill
        height: toolsWidget.implicitHeight - colors.widgetPillPaddingV * 2
        width: row.implicitWidth + colors.widgetPillPaddingH * 2
        anchors.verticalCenter: parent.verticalCenter
        radius: colors.widgetPillRadius
        color: mouseArea.pressed ? Qt.darker(toolsWidget.pillColor, 1.15) : mouseArea.containsMouse ? Qt.lighter(toolsWidget.pillColor, 1.2) : toolsWidget.pillColor
        border.width: 1
        border.color: mouseArea.containsMouse ? Qt.lighter(toolsWidget.pillColor, 1.4) : toolsWidget.pillColor
        ...
        MouseArea {
            ...
            Row {
                ...
                Text {
                    text: "\uF0AD"
                    color: toolsWidget.pillTextColor
